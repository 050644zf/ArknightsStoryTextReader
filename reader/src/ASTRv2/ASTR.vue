...
[class*=" terminal-"] {
  ...
  font-family: "ak_terminal" !important;
  speak: never;
  font-style: normal;
  font-weight: normal;
  font-variant: normal;
...
.terminal-intermezzi:before {
  content: "\e900";
}

.terminal-maintheme:before {
  content: "\e901";
}

.terminal-record:before {
  content: "\e902";
}

.terminal-sidestory:before {
  content: "\e903";
}

.terminal-storyset:before {
  content: "\e904";
}
...
.n-card--hoverable:hover {
  /* green box shadow */
  box-shadow: 0px 0px 10px rgba(135, 193, 175, 0.5) !important;
  /* add border */
  border: 1px solid rgba(135, 193, 175, 0.5) !important;
}
</style>
