<template>
    <n-auto-complete :placeholder="i18n.warp[currentLang]" v-model:value="value" :options="options" @select="select"
        :class="{'warp-search':true, 'warp-search-active':focused}" clear-after-select blur-after-select
        @focus="focused = true" @blur="focused = false; value=null" />
</template>
